...
standalone authority. The score is derived from explicit acquisition, soft-decision,
secondary-sync, demodulation, and CRC evidence. Acquisition confidence is an
uncalibrated diagnostic, not a probability of correct reception.
